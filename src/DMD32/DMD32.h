...
// ── SEM Race Clock pin assignment (VSPI hardware SPI) ──────────────────────
// CLK and R_DATA are driven by hardware SPI (VSPI defaults); the others are
// software GPIO toggled during scanDisplayBySPI().
#define PIN_DMD_nOE      4   // GPIO4  — output enable, active low
#define PIN_DMD_A        16  // GPIO16 — row select A
#define PIN_DMD_B        17  // GPIO17 — row select B
#define PIN_DMD_CLK      18  // GPIO18 — SPI clock  (VSPI SCK,  hardware)
#define PIN_DMD_SCLK     5   // GPIO5  — shift-reg latch (VSPI SS repurposed)
#define PIN_DMD_R_DATA   23  // GPIO23 — SPI data   (VSPI MOSI, hardware)
#define PIN_OTHER_SPI_nCS SS // not used; kept for library compatibility
// ───────────────────────────────────────────────────────────────────────────
